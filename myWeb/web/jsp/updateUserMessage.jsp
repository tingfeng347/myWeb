...
<form action="<%=request.getContextPath()%>/updateUserMessage" method="post">
    ...
    <table border="0" width="200" height="250">
        ...
        <tr>
        <tr align="center">
            <td colspan="2"><input type="submit" value="提交" style="width: 60px; height: 30px;">&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="reset" value="取消" style="width: 60px; height: 30px;"></td>
        </tr>
